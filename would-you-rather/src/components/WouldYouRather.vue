...
const choice = ref('') // choice is reactive variable, initialized as empty string, stores users selected choice

watch(choice, () => { // watch the choice data, emit an event when it changes
